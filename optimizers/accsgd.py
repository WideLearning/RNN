"""
From https://github.com/rahulkidambi/AccSGD/blob/master/AccSGD.py
"""
import copy
...
class AccSGD(Optimizer):
    ...
    def __init__(
        self, params, lr=required, kappa=1000.0, xi=10.0, smallConst=0.7, weight_decay=0
    ):
        defaults = dict(
            lr=lr, kappa=kappa, xi=xi, smallConst=smallConst, weight_decay=weight_decay
        )
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            ...
            Alpha = 1.0 - (
                (group["smallConst"] * group["smallConst"] * group["xi"])
                / group["kappa"]
            )
            Beta = 1.0 - Alpha
